...
Realizado durante o evento  (Missão - Programação <do zero/>) que ocorreu entre os dias 14, 15, 16 e 20 de Outubro de 2024, focado em pessoas com zero conhecimento nas linguagens de Programação: CSS e Java Script, utilizando o HTML como marcação/estrutura para a criação de uma página web, oferecido de maneira online e gratuita pelo: @rodolfomori.
